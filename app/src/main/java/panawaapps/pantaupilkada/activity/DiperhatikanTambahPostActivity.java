...
public class DiperhatikanTambahPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diperhatikan_tambah_post);
        ...
        pref = PreferenceManager
                .getDefaultSharedPreferences(DiperhatikanTambahPostActivity.this);
    ...
    public void postDiperhatikan(){
        ...
        apiAdapter.getRestApi().postComments(token, coupleid, comments.getTitle(), comments.getText(), comments.getFeedback(), new Callback<CommentsData>() {
            ...
            public void success(CommentsData commentsData, Response response) {
                ...
                Intent intent = new Intent(DiperhatikanTambahPostActivity.this, HomeActivity.class);
